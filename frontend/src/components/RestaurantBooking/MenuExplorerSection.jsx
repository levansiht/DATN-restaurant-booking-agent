            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {visibleItems.map((item) => {
                ...
                return (
                  <article
                    key={item.id}
                    className="flex h-full flex-col overflow-hidden rounded-[2rem] border border-[#e5d3b7] bg-white shadow-[0_18px_50px_rgba(55,39,27,0.08)]"
                  >
                    <div className="relative h-56 shrink-0 overflow-hidden bg-[#efe1d0]">
                      <img
                        src={item.image_url}
                    ...
                    <div className="flex flex-1 flex-col gap-4 px-5 py-5">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="shrink-0 rounded-full bg-[#f5e5d0] px-3 py-2 text-sm font-semibold text-[#8b2328]">
                      ...
                      {/* Primary actions first, then secondary, kept aligned at the
                          bottom of every card via mt-auto so rows line up. */}
